/**
 * SignupScreen.js - Handles user signup.
 */
...
const SignupScreen = () => {
  ...
  const { signup, phoneSignup, phoneLogin, googleLogin } = useContext(AuthContext);
    ...
    return (
      <View style={[styles.container, { backgroundColor: themeStyles[theme].backgroundColor }]}>
        <AuthForm
          ...
          handleEmailPasswordAuth={handleEmailPasswordSignup}
